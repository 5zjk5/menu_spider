...
#  Apr 24, 2020 09:00:44 PM CST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 608x650+622+149
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $top.but44 \
        ...
        -background $vTcl(actual_gui_bg) -command creat_menu \
    ...
    bind $top.but44 <<SetBalloon>> {
        set ::vTcl::balloon::%W {生成今日菜单}
    }
    button $top.but45 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command clean \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text 清除 
    ...
    bind $top.but45 <<SetBalloon>> {
        set ::vTcl::balloon::%W {不满意，再来~}
    }
    text $top.tex46 \
        -background white -font TkTextFont -foreground black -height 235 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 485 -wrap word 
    ...
    ###################
    place $top.but44 \
        -in $top -x 0 -relx 0.148 -y 0 -rely 0.046 -width 135 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but45 \
        -in $top -x 0 -relx 0.633 -y 0 -rely 0.046 -width 135 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tex46 \
        -in $top -x 0 -relx 0.099 -y 0 -rely 0.154 -width 0 -relwidth 0.798 \
        -height 0 -relheight 0.363 -anchor nw -bordermode ignore 
    place $top.lab47 \
        -in $top -x 0 -relx 0.099 -y 0 -rely 0.631 -width 0 -relwidth 0.786 \
        -height 0 -relheight 0.278 -anchor nw -bordermode ignore 
    place $top.lab45 \
        -in $top -x 0 -relx 0.417 -y 0 -rely 0.554 -width 0 -relwidth 0.137 \
